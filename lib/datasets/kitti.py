...
class kitti(imdb):
    ...
    def _get_default_path(self):
        """
        Return the default path where KITTI VOC is expected to be installed.
        """
        return os.path.join(cfg.DATA_DIR, 'KITTIdevkit' + self._year)
    ...
    def _load_kitti_annotation(self, index):
        """
        Load image and bounding boxes info from XML file in the KITTI VOC
        format.
        """
    ...
    def _do_python_eval(self, output_dir = 'output'):
        ...
        aps = []
        # The KITTI metric changed in 2010
