...
import subprocess
import uuid
from cam2_eval import cam2_eval
...
class cam2(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        ...
        assert os.path.exists(self._devkit_path), \
                'CAM2devkit path does not exist: {}'.format(self._devkit_path)
    ...
    def _load_image_set_index(self):
        ...
        # self._devkit_path + /CAM2devkit2017/CAM2_2017/ImageSets/Main/val.txt
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join(cfg.DATA_DIR, 'CAM2devkit')
    ...
    def _get_voc_results_file_template(self):
        ...
        # CAM2devkit/results/CAM2_2017/Main/<comp_id>_det_test_aeroplane.txt
    ...
    def _write_voc_results_file(self, all_boxes):
        for cls_ind, cls in enumerate(self.classes):
            if cls == '__background__':
                continue
            print 'Writing {} CAM2 results file'.format(cls)
        ...
        for i, cls in enumerate(self._classes):
            ...
            if "person" in cls:
                if cls == '__background__':
                    continue
                filename = self._get_voc_results_file_template().format(cls)
                rec, prec, ap, ovthresh = cam2_eval(
